...
public class Example7 {
    ...
    public static void main(String[] args) {
         ...
         String s17="Now is the time for all goodmen to "+"come to thier country and pay their "+" due taxes";
         ...
         String s22="No concession, no concillation,"+"no confident,and no give and take";
